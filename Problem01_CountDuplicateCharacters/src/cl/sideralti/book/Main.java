...
public class Main {
    ...
    private static final String TEXT = "Be strong, be fearless, be beautiful. "
            ...
            + "people there to support you.  zzZZZ ññÑ                  ";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Solución basada en HashMap  (Map<Character, Integer>): ");
        long startTimeV1 = System.nanoTime();

        Map<Character, Integer> duplicatesV1 = StringMethod.countDuplicateCharactersV1(TEXT);
        ...
        Map<Character, Long> duplicatesV2 = StringMethod.countDuplicateCharactersV2(TEXT);
        ...
        Map<String, Integer> duplicatesV3 = StringMethod.countDuplicateCharactersVCP1(TEXT_CP);
        ...
        Map<String, Long> duplicatesV4 = StringMethod.countDuplicateCharactersVCP2(TEXT_CP);
